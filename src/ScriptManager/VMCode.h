...
VMCODE2( VM_GUNEG,					OpGUNeg )
VMCODE0( VM_GUEQ,						OpGUEq )
VMCODE0( VM_GUNE,						OpGUNe )
VMCODE0( VM_GUGT,						OpGUGt )
VMCODE0( VM_GUGE,						OpGUGe )
VMCODE0( VM_GULT,						OpGULt )
VMCODE0( VM_GULE,						OpGULe )
VMCODE0( VM_GUADD,					OpGUAdd )
VMCODE0( VM_GUSUB,					OpGUSub )
VMCODE0( VM_GUMUL,					OpGUMul )
VMCODE0( VM_GUDIV,					OpGUDiv )
