...
namespace VM
{
	...
	enum
	{
		...
		// For enemy shot.
		SYS_CREATE_LASER_SHOT_1,
		SYS_CREATE_LASER_SHOT_1_LOCAL,
		SYS_CREATE_BEAM_SHOT_1,
		SYS_CREATE_BEAM_SHOT_1_LOCAL,
		SYS_SET_LASER_SHOT_LENGTH,
		SYS_SET_BEAM_SHOT_LENGTH,
