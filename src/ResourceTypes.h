...
namespace GameEngine
{
	...
	enum GlobalTexAtlasID
	{
		...
		GLOBAL_TEX_ATLAS_ID_FONT_LAST							= 47,
		GLOBAL_TEX_ATLAS_ID_ENEMY_SHOT_FIRST					= 48,
		GLOBAL_TEX_ATLAS_ID_ENEMY_SHOT_LAST						= 168,
		GLOBAL_TEX_ATLAS_ID_ENEMY_SHOT_LASER_EFFECT_FIRST		= 1000,
		GLOBAL_TEX_ATLAS_ID_ENENY_SHOT_LASER_EFFECT_LAST		= 1999,
	};
